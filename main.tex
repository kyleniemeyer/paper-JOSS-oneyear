...
\add{The article describes the software from a high level, and the software itself includes both source code and associated artifacts such as tests, documentation, and examples.}
