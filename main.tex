...
Similar to how we handle new software versions, the \joss{} editorial board will consider publication of articles describing a fork if it includes substantial changes from a previously published version.
...
However, while a version control history generally makes it easy to suggest people who should be authors, ultimately deciding on authorship is hard and project-dependent.
We prefer to leave authorship decisions to the projects.
}
...
Most other articles have received no citations yet, though some have been cited five times or fewer.}
