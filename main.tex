...
\affil[8]{Department of Psychology, Boston College, Chestnut Hill, MA, USA}
...
Initially, the peer-review process for these software articles was the same as for any other research article, but this is now changing, particularly as journals that specialize in software have appeared: the \textit{Journal of Open Research Software} (\textit{JORS},
...
Both \textit{JORS}~\cite{jorsreview}
%(\href{http://openresearchsoftware.metajnl.com/about/#q4}{openresearchsoftware.metajnl.com/about/\#q4})
and \textit{SoftwareX}~\cite{els-software}
%(\href{https://www.elsevier.com/books-and-journals/enrichments/original-software-publications#submission}{elsevier.com/books-and-journals/enrichments/original-software-publications\#submission})
...
for updates may be attributed to reviewers (or editors) missing GitHub
emails from the review issue comments.
