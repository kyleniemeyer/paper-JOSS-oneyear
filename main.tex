...
\add{We expect this article to be of interest to three core audiences: (1) researchers who develop software and could submit their work to \joss{},
...
\add{The article describes the software at a high level, and the software itself includes both source code and associated artifacts such as tests, documentation, and examples.}
...
\add{Furthermore, because all potential uses of the software are not
